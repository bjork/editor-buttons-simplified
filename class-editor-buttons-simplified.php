...
class Editor_Buttons_Simplified {
	...
	function __construct() {
		add_filter( 'mce_buttons',          array( $this, 'ebs_tinymce_buttons_row_1' ) );
		add_filter( 'mce_buttons_2',        array( $this, 'ebs_tinymce_buttons_row_2' ) );
		add_filter( 'tiny_mce_before_init', array( $this, 'ebs_tinymce_block_format_mod' ) );
	}
